...
class Configuration:
    ...
    _WORKFLOW_CONTROLLER_INSTANCE_MIDDLETIER_NAMESPACE = os.environ["WORKFLOW_METRICS_MIDDLETIER_PROMETHEUS_INSTANCE"]
    _THOTH_MIDDLETIER_NAMESPACE = os.environ["THOTH_MIDDLETIER_NAMESPACE"]

    # Workflows amun-inspection namespace
    _WORKFLOW_CONTROLLER_INSTANCE_AMUN_INSPECTION_NAMESPACE = os.environ["WORKFLOW_METRICS_AMUN_INSPECTION_PROMETHEUS_INSTANCE"]
    _THOTH_AMUN_INSPECTION_NAMESPACE = os.environ["THOTH_AMUN_INSPECTION_NAMESPACE"]